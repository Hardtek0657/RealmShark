...
public class FameSessionViewer extends JFrame {
    ...
    private JComboBox<Integer> characterSelector;
    ...
    private void initializeUI() {
        ...
        selectorPanel.add(new JLabel("Select Character: "));
    ...
    private void populateCharacterFameData() {
        ...
        for (Integer charId : fameData.keySet()) {
            ...
            if (entries != null && !entries.isEmpty()) {
                ...
                double startFame = entries.get(0).fame;
                double endFame = entries.get(entries.size() - 1).fame;
                ...
                characterSelector.addItem(charId);
            }
        }
    ...
    private void populateDungeonFilter() {
        ...
        Integer selectedCharId = (Integer) characterSelector.getSelectedItem();
    ...
    private class GraphTabPanel
        ...
        private MinMax getMinMaxScore() {
            ...
            minMax.minScoreX = scores.get(0).time;
            minMax.maxScoreX = scores.get(0).time;
            minMax.minScoreY = scores.get(0).fame;
            minMax.maxScoreY = scores.get(0).fame;
        ...
        public void mouseMoved(MouseEvent e) {
            ...
            if (!scores.isEmpty()) {
                ...
                if (index >= 0 && index < scores.size()) {
                    hoverFame = scores.get(index).fame;
                    repaint();
                }
            }
        }
        ...
        private int findClosestPoint(int x) {
            ...
            for (int i = 0; i < scores.size(); i++) {
                ...
                double pointX =
                    padding +
                    labelPadding +
                    (score.time - minMax.minScoreX) * xScale;
